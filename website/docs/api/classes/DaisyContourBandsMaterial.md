...
[daisy-space-sdk](../README.md) / DaisyContourBandsMaterial
...
> **new DaisyContourBandsMaterial**(`options?`): `DaisyContourBandsMaterial`
...
> `readonly` `static` **type**: `"DaisyContourBands"` = `MATERIAL_TYPE_DAISY_CONTOUR_BANDS`
