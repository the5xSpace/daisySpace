...
[daisy-space-sdk](../README.md) / [Daisy](../modules/Daisy.md) / ImageryProvider
...
> `static` **loadImage**(`imageryProvider`, `url`): `Promise`\<[`ImageryTypes`](../types/Daisy.ImageryTypes.md) \| `CompressedTextureBuffer`\> \| `undefined`
...
`Promise`\<[`ImageryTypes`](../types/Daisy.ImageryTypes.md) \| `CompressedTextureBuffer`\> \| `undefined`
