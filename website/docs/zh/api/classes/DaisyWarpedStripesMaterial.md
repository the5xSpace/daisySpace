...
[daisy-space-sdk](../README.md) / DaisyWarpedStripesMaterial
...
> **new DaisyWarpedStripesMaterial**(`options?`): `DaisyWarpedStripesMaterial`
...
> `readonly` `static` **type**: `"DaisyWarpedStripes"` = `MATERIAL_TYPE_DAISY_WARPED_STRIPES`
