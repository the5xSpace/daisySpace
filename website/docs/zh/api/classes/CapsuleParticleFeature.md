...
[daisy-space-sdk](../README.md) / CapsuleParticleFeature
...
> **new CapsuleParticleFeature**(`options?`): `CapsuleParticleFeature`
...
> `readonly` `static` **type**: `"CapsuleParticleFeature"` = `"CapsuleParticleFeature"`
...
> **get** **options**(): [`CapsuleParticleOptions`](../interfaces/CapsuleParticleOptions.md)
...
`Partial`\<[`CapsuleParticleOptions`](../interfaces/CapsuleParticleOptions.md)\>
...
> **getCurrentFrameMetadata**(): [`CapsuleParticleFrameMetadata`](../interfaces/CapsuleParticleFrameMetadata.md) \| `undefined`

#### Returns

[`CapsuleParticleFrameMetadata`](../interfaces/CapsuleParticleFrameMetadata.md) \| `undefined`
...
> **getFrameMetadata**(): [`CapsuleParticleFrameMetadata`](../interfaces/CapsuleParticleFrameMetadata.md)[]
...
> **register**(`entity`): `CapsuleParticleFeature`
