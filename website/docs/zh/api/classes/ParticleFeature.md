...
`Partial`\<[`ParticleFeatureOptions`](../interfaces/ParticleFeatureOptions.md)\>
...
> **setImageErrorHandler**(`handler?`): `this`

Runtime adapters can route asynchronous asset failures into diagnostics.
