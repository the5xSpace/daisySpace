...
[daisy-space-sdk](../README.md) / CorridorFeature
...
> **new CorridorFeature**(`options`): `CorridorFeature`
...
> `readonly` `static` **type**: `"CorridorFeature"` = `"CorridorFeature"`
...
> **get** **options**(): [`CorridorOptions`](../types/CorridorOptions.md)
...
`Partial`\<[`CorridorOptions`](../types/CorridorOptions.md)\>
...
> **register**(`entity`): `CorridorFeature`
