...
[daisy-space-sdk](../README.md) / DownEmitDiffuseMaterial
...
> **new DownEmitDiffuseMaterial**(`options?`): `DownEmitDiffuseMaterial`
...
> `readonly` `static` **type**: `"DownEmitDiffuse"` = `MATERIAL_TYPE_DOWN_EMIT_DIFFUSE`
