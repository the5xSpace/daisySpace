...
> **相关 API**：[PolylineFeature](/api/classes/PolylineFeature) · [CorridorFeature](/api/classes/CorridorFeature) · [WallFeature](/api/classes/WallFeature) · [PolylineVolumeFeature](/api/classes/PolylineVolumeFeature) · [ArrowPointerFeature](/api/classes/ArrowPointerFeature) · [MaterialFactory](/api/classes/MaterialFactory)
