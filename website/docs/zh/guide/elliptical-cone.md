...
[EllipticalConeFeature](/api/classes/EllipticalConeFeature) 是一个椭圆锥/椭圆台图元组件，基于 [EllipticConeGeometry](/api/classes/EllipticConeGeometry) 构建。X/Y 轴开口角可独立设置，常被 Sensor 组件用于渲染波束体积。
...
> **相关 API**：[EllipticalConeFeature](/api/classes/EllipticalConeFeature) · [EllipticConeGeometry](/api/classes/EllipticConeGeometry)
