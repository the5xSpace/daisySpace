...
`PathBuilder` creates a path from a set of waypoints, producing two kinds of output:
...
| Geodesic | `.setInterpolation("geodesic")` | Great-circle path (optimal earth-surface route) |
