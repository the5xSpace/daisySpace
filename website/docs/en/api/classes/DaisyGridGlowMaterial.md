...
[daisy-space-sdk](../README.md) / DaisyGridGlowMaterial
...
> **new DaisyGridGlowMaterial**(`options?`): `DaisyGridGlowMaterial`
...
> `readonly` `static` **type**: `"DaisyGridGlow"` = `MATERIAL_TYPE_DAISY_GRID_GLOW`
