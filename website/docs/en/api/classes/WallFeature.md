...
[daisy-space-sdk](../README.md) / WallFeature
...
> **new WallFeature**(`options`): `WallFeature`
...
> `readonly` `static` **type**: `"WallFeature"` = `"WallFeature"`
...
> **get** **options**(): [`WallOptions`](../types/WallOptions.md)
