...
[daisy-space-sdk](../README.md) / DaisyTurbulenceMaterial
...
> **new DaisyTurbulenceMaterial**(`options?`): `DaisyTurbulenceMaterial`
...
> `readonly` `static` **type**: `"DaisyTurbulence"` = `MATERIAL_TYPE_DAISY_TURBULENCE`
