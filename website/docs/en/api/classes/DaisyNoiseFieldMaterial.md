...
[daisy-space-sdk](../README.md) / DaisyNoiseFieldMaterial
...
> **new DaisyNoiseFieldMaterial**(`options?`): `DaisyNoiseFieldMaterial`
...
> `readonly` `static` **type**: `"DaisyNoiseField"` = `MATERIAL_TYPE_DAISY_NOISE_FIELD`
