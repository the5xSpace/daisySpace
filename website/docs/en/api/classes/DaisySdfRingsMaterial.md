...
[daisy-space-sdk](../README.md) / DaisySdfRingsMaterial
...
> **new DaisySdfRingsMaterial**(`options?`): `DaisySdfRingsMaterial`
...
> `readonly` `static` **type**: `"DaisySdfRings"` = `MATERIAL_TYPE_DAISY_SDF_RINGS`
