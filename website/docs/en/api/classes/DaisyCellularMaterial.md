...
[daisy-space-sdk](../README.md) / DaisyCellularMaterial
...
> **new DaisyCellularMaterial**(`options?`): `DaisyCellularMaterial`
...
> `readonly` `static` **type**: `"DaisyCellular"` = `MATERIAL_TYPE_DAISY_CELLULAR`
