...
[daisy-space-sdk](../README.md) / DaisyTopoRippleMaterial
...
> **new DaisyTopoRippleMaterial**(`options?`): `DaisyTopoRippleMaterial`
...
> `readonly` `static` **type**: `"DaisyTopoRipple"` = `MATERIAL_TYPE_DAISY_TOPO_RIPPLE`
