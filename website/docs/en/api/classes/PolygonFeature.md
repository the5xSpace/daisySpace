...
[daisy-space-sdk](../README.md) / PolygonFeature
...
Supports:
- Multiple inputs such as `Daisy.PolygonHierarchy`, `Holes`, and Pathway
- Optional outline, ground clamping/extrusion, and texture coordinates
- LOD show/hide by distance-display policy
...
> **new PolygonFeature**(`options`): `PolygonFeature`
...
> `readonly` `static` **type**: `"PolygonFeature"` = `'PolygonFeature'`
...
> **get** **options**(): [`PolygonOptions`](../types/PolygonOptions.md)
...
> **register**(`entity`): `PolygonFeature`
