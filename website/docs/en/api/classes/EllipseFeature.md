...
[daisy-space-sdk](../README.md) / EllipseFeature

# Class: EllipseFeature
...
> **new EllipseFeature**(`options?`): `EllipseFeature`
...
> `readonly` `static` **type**: `"EllipseFeature"` = `"EllipseFeature"`
...
> **get** **options**(): [`EllipseOptions`](../types/EllipseOptions.md)
...
> **register**(`entity`): `EllipseFeature`
