...
[daisy-space-sdk](../README.md) / DaisyCircuitMaterial
...
> **new DaisyCircuitMaterial**(`options?`): `DaisyCircuitMaterial`
...
> `readonly` `static` **type**: `"DaisyCircuit"` = `MATERIAL_TYPE_DAISY_CIRCUIT`
