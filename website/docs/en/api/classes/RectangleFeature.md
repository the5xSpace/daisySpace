...
[daisy-space-sdk](../README.md) / RectangleFeature
...
> **new RectangleFeature**(`options?`): `RectangleFeature`
...
> `readonly` `static` **type**: `"RectangleFeature"` = `"RectangleFeature"`
...
> **get** **options**(): [`RectangleOptions`](../types/RectangleOptions.md)
...
> **register**(`entity`): `RectangleFeature`
