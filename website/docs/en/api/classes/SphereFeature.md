...
[daisy-space-sdk](../README.md) / SphereFeature

# Class: SphereFeature

Sphere feature (SphereFeature).

Used when a sphere needs to be expressed explicitly; internally reuses the stable EllipsoidFeature rendering path.
...
> **new SphereFeature**(`options?`): `SphereFeature`
...
> `readonly` `static` **type**: `"SphereFeature"` = `"SphereFeature"`
...
> **get** **options**(): [`SphereOptions`](../interfaces/SphereOptions.md)
