...
[daisy-space-sdk](../README.md) / SpiralFlowMaterial
...
```ts
const material = new Daisy.SpiralFlowMaterial({
 direction: -1,
 count: 0.4,
...
> **new SpiralFlowMaterial**(`options?`): `SpiralFlowMaterial`
...
> `readonly` `static` **type**: `"SpiralFlow"` = `MATERIAL_TYPE_SPIRAL_FLOW`
