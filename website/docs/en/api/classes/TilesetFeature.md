...
Provides:
- Lifecycle (register/update/destroy) base flow
- Association with Entity/Engine
- Common capabilities: Transformer and BodyAxis
...
Registers a tileset load completion callback.
If the tileset is already loaded, the callback executes immediately.
