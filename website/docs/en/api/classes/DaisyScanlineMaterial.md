...
[daisy-space-sdk](../README.md) / DaisyScanlineMaterial
...
> **new DaisyScanlineMaterial**(`options?`): `DaisyScanlineMaterial`
...
> `readonly` `static` **type**: `"DaisyScanline"` = `MATERIAL_TYPE_DAISY_SCANLINE`
