...
[daisy-space-sdk](../README.md) / [PW](../modules/PW.md) / Vessel

# Class: Vessel

Vessel: a ship or surface platform, a semantic alias of Vehicle.

Description:
- The default sensor mount direction reuses Vehicle (currently TO_FRONT)
...
// 前视传感器（复用 Vehicle 默认）
vessel.addSensor({ apertureDeg: { xDeg: 6, yDeg: 3 }, beamLength: 80_000 });
```
...
> **new Vessel**(`options?`, `celestialEllipsoid?`): `Vessel`
