...
[daisy-space-sdk](../README.md) / PolylineVolumeFeature

# Class: PolylineVolumeFeature

Feature base class.

Provides:
- Lifecycle basics (register/update/destroy)
- Association with Entity/Engine
- Common capabilities such as Transformer and BodyAxis
...
> **new PolylineVolumeFeature**(`options`): `PolylineVolumeFeature`
...
> `readonly` `static` **type**: `"PolylineVolumeFeature"` = `"PolylineVolumeFeature"`
...
> **get** **options**(): [`PolylineVolumeOptions`](../types/PolylineVolumeOptions.md)
...
> **register**(`entity`): `PolylineVolumeFeature`
