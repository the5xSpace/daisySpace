...
[daisy-space-sdk](../README.md) / FreeGeometryFeature
...
const feature = new Daisy.FreeGeometryFeature({
 geometry: {
 positions: [
 [0,0,0], [100,0,0], [0,100,0], [50,50,100]
 ],
 indices: [0,1,2, 0,1,3, 1,2,3, 2,0,3],
 },
 material: Daisy.MaterialFactory.Solid({ color: "#34d399", alpha: 0.8 }),
 doubleSided: true,
 outline: true,
});
...
> **new FreeGeometryFeature**(`options`): `FreeGeometryFeature`
...
> `readonly` `static` **type**: `"FreeGeometry"` = `"FreeGeometry"`
...
> **get** **options**(): [`FreeGeometryOptions`](../interfaces/FreeGeometryOptions.md)
...
`Partial`\<[`FreeGeometryOptions`](../interfaces/FreeGeometryOptions.md)\>
...
> **register**(`entity`): `FreeGeometryFeature`
