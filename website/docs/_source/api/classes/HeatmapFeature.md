...
[daisy-space-sdk](../README.md) / HeatmapFeature
...
> **new HeatmapFeature**(`options`): `HeatmapFeature`
...
> `readonly` `static` **type**: `"HeatmapFeature"` = `"HeatmapFeature"`
...
> **setCoverageGrid**(`grid`, `masks?`): `void`
