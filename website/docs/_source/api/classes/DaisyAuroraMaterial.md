...
[daisy-space-sdk](../README.md) / DaisyAuroraMaterial
...
> **new DaisyAuroraMaterial**(`options?`): `DaisyAuroraMaterial`
...
> `readonly` `static` **type**: `"DaisyAurora"` = `MATERIAL_TYPE_DAISY_AURORA`
