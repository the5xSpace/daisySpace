...
[daisy-space-sdk](../README.md) / RadialPulseMaterial
...
> **new RadialPulseMaterial**(`options?`): `RadialPulseMaterial`
...
> `readonly` `static` **type**: `"RadialPulse"` = `MATERIAL_TYPE_RADIAL_PULSE`
