...
[daisy-space-sdk](../README.md) / DaisyMatrixRainMaterial
...
> **new DaisyMatrixRainMaterial**(`options?`): `DaisyMatrixRainMaterial`
...
> `readonly` `static` **type**: `"DaisyMatrixRain"` = `MATERIAL_TYPE_DAISY_MATRIX_RAIN`
