...
[daisy-space-sdk](../README.md) / TilesetFeature

# Class: TilesetFeature
...
> **new TilesetFeature**(`options?`): `TilesetFeature`
...
> `readonly` `static` **type**: `"TilesetFeature"` = `"TilesetFeature"`
...
> **get** **options**(): [`TilesetOptions`](../types/TilesetOptions.md)
...
`Partial`\<[`TilesetOptions`](../types/TilesetOptions.md)\>
...
> **register**(`entity`): `TilesetFeature`
