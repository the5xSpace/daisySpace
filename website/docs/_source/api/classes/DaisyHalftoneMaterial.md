...
[daisy-space-sdk](../README.md) / DaisyHalftoneMaterial
...
> **new DaisyHalftoneMaterial**(`options?`): `DaisyHalftoneMaterial`
...
> `readonly` `static` **type**: `"DaisyHalftone"` = `MATERIAL_TYPE_DAISY_HALFTONE`
