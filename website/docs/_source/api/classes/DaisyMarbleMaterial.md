...
[daisy-space-sdk](../README.md) / DaisyMarbleMaterial
...
> **new DaisyMarbleMaterial**(`options?`): `DaisyMarbleMaterial`
...
> `readonly` `static` **type**: `"DaisyMarble"` = `MATERIAL_TYPE_DAISY_MARBLE`
