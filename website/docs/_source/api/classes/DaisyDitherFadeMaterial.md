...
[daisy-space-sdk](../README.md) / DaisyDitherFadeMaterial
...
> **new DaisyDitherFadeMaterial**(`options?`): `DaisyDitherFadeMaterial`
...
> `readonly` `static` **type**: `"DaisyDitherFade"` = `MATERIAL_TYPE_DAISY_DITHER_FADE`
