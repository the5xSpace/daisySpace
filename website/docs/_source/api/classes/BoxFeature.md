...
[daisy-space-sdk](../README.md) / BoxFeature
...
> **new BoxFeature**(`options`): `BoxFeature`
...
> `readonly` `static` **type**: `"BoxFeature"` = `"BoxFeature"`
...
> **get** **options**(): [`BoxComponentEntityComOptions`](../interfaces/BoxComponentEntityComOptions.md)
...
`Partial`\<[`BoxComponentEntityComOptions`](../interfaces/BoxComponentEntityComOptions.md)\>
