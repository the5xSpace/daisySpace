...
[daisy-space-sdk](../README.md) / EllipsoidFeature

# Class: EllipsoidFeature

椭球体要素（EllipsoidFeature）。
...
> **new EllipsoidFeature**(`options`): `EllipsoidFeature`
...
> `readonly` `static` **type**: `"EllipsoidFeature"` = `"EllipsoidFeature"`
...
> **get** **options**(): [`EllipsoidOptions`](../interfaces/EllipsoidOptions.md)
...
> **register**(`entity`): `EllipsoidFeature`
