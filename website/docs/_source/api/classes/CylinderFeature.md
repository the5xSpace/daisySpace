...
[daisy-space-sdk](../README.md) / CylinderFeature

# Class: CylinderFeature

圆柱/圆台要素（CylinderFeature）。

通过 `emitDirection` 可实现以顶部/底部/中心等基准对齐，或延伸至地表。
...
> **new CylinderFeature**(`options?`): `CylinderFeature`
...
> **cylinder**: [`CylinderGeometry`](CylinderGeometry.md) \| `undefined`
...
> `readonly` `static` **type**: `"CylinderFeature"` = `'CylinderFeature'`
...
> **get** **options**(): [`CylinderOptions`](../interfaces/CylinderOptions.md)
...
`Partial`\<[`CylinderOptions`](../interfaces/CylinderOptions.md)\>
...
> **createPrimitive**(): [`CylinderGeometry`](CylinderGeometry.md)
...
> **register**(`entity`): `CylinderFeature`
