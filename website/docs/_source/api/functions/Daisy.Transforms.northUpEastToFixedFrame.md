...
[daisy-space-sdk](../README.md) / [Daisy](../modules/Daisy.md) / [Transforms](../modules/Daisy.Transforms.md) / northUpEastToFixedFrame

# Function: northUpEastToFixedFrame()

> **northUpEastToFixedFrame**(`origin`, `ellipsoid?`, `result?`): [`Matrix4`](../classes/Daisy.Matrix4.md)
...
const transform = Daisy.Transforms.northUpEastToFixedFrame(center);
```
