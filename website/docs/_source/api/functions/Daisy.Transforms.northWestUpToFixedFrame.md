...
[daisy-space-sdk](../README.md) / [Daisy](../modules/Daisy.md) / [Transforms](../modules/Daisy.Transforms.md) / northWestUpToFixedFrame

# Function: northWestUpToFixedFrame()

> **northWestUpToFixedFrame**(`origin`, `ellipsoid?`, `result?`): [`Matrix4`](../classes/Daisy.Matrix4.md)
...
const transform = Daisy.Transforms.northWestUpToFixedFrame(center);
```
