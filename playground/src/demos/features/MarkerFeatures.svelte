...
//
// 本示例演示如何创建 PointFeature（点标记）和 LabelFeature（标签）组件。
// 这两个是最常用的标记组件，用于在地图上显示位置和文字信息。
//
// 关键 API：
...
// ── 3. 添加 LabelFeature（标签） ──────────────────────────────────────────
// LabelFeature: 标签组件，用于在地图上显示文字信息
// 参数说明：
//   - text: 显示文本
//   - font: 字体样式（CSS 格式）
//   - fillColor: 文字颜色
...
e1.addFeature(new Daisy.UI.LabelFeature({
...
// 输出创建信息
__log("MarkerFeatures 已创建: Point + Label");
// =============================================================================
</script>
